var mainpanel, ps, sidebar, ps1, sidebarwrapper, ps2, dropdownmenu, ps3, pageheader, ps4, isWindows = -1 < navigator.platform.indexOf("Win");
...
function debounce(a, i, n) {
    ...
    return function() {
        var e = this,
            t = arguments;
        clearTimeout(o), o = setTimeout(function() { o = null, n || a.apply(e, t) }, i), n && !o && a.apply(e, t)
    }
}
$(document).ready(function() {
    ...
    }), $(".collapse").on("show.bs.collapse", function() { $(this).parent().siblings().children(".collapse").each(function() { $(this).collapse("hide") }) }), 0 != $(".selectpicker").length && $(".selectpicker").selectpicker(), $('[rel="tooltip"]').tooltip(), $('[data-toggle="popover"]').popover();
    ...
    0 != $(".tagsinput").length && $(".tagsinput").tagsinput(), $(".bootstrap-tagsinput").addClass(e + "-badge"), $(".select").dropdown({ dropdownClass: "dropdown-menu", optionClass: "" }), $(".form-control").on("focus", function() { $(this).parent(".input-group").addClass("input-group-focus") }).on("blur", function() { $(this).parent(".input-group").removeClass("input-group-focus") }), 1 == breakCards && $('[data-header-animation="true"]').each(function() {
        ...
        t.find(".fix-broken-card").click(function() {
            ...
            e.removeClass("hinge").addClass("fadeInDown"), t.attr("data-count", 0), setTimeout(function() { e.removeClass("fadeInDown animate") }, 480)
    ...
    var e;
    $toggle = $(this), mobile_menu_visible = 1 == mobile_menu_visible ? ($("html").removeClass("nav-open"), $(".close-layer").remove(), setTimeout(function() { $toggle.removeClass("toggled") }, 400), 0) : (setTimeout(function() { $toggle.addClass("toggled") }, 430), e = $('<div class="close-layer"></div>'), 0 != $("body").find(".main-panel").length ? e.appendTo(".main-panel") : $("body").hasClass("off-canvas-sidebar") && e.appendTo(".wrapper-full-page"), setTimeout(function() { e.addClass("visible") }, 100), e.click(function() { $("html").removeClass("nav-open"), mobile_menu_visible = 0, e.removeClass("visible"), setTimeout(function() { e.remove(), $toggle.removeClass("toggled") }, 400) }), $("html").addClass("nav-open"), 1)
    ...
    checkSidebarImage: function() { $sidebar = $(".sidebar"), image_src = $sidebar.data("image"), void 0 !== image_src && $(".sidebar-background").css("background-image", "url(" + image_src + ")") },
    showNotification: function(e, t) { type = ["", "info", "danger", "success", "warning", "rose", "primary"], color = Math.floor(6 * Math.random() + 1), $.notify({ icon: "add_alert", message: "Welcome to <b>Material Dashboard Pro</b> - a beautiful admin panel for every web developer." }, { type: type[color], timer: 3e3, placement: { from: e, align: t } }) },
    initDocumentationCharts: function() {
        ...
        }, optionsDailySalesChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 0 }), low: 0, high: 50, chartPadding: { top: 0, right: 0, bottom: 0, left: 0 } }, new Chartist.Line("#dailySalesChart", dataDailySalesChart, optionsDailySalesChart), new Chartist.Line("#websiteViewsChart", dataDailySalesChart, optionsDailySalesChart))
    },
    ...
    initDashboardPageCharts: function() {
        ...
        }, optionsDailySalesChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 0 }), low: 0, high: 50, chartPadding: { top: 0, right: 0, bottom: 0, left: 0 } }, e = new Chartist.Line("#dailySalesChart", dataDailySalesChart, optionsDailySalesChart), md.startAnimationForLineChart(e), dataCompletedTasksChart = {
            labels: ["12p", "3p", "6p", "9p", "12p", "3a", "6a", "9a"],
            series: [
                [230, 750, 450, 300, 280, 240, 200, 190]
            ]
        }, optionsCompletedTasksChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 0 }), low: 0, high: 1e3, chartPadding: { top: 0, right: 0, bottom: 0, left: 0 } }, t = new Chartist.Line("#completedTasksChart", dataCompletedTasksChart, optionsCompletedTasksChart), md.startAnimationForLineChart(t), a = Chartist.Bar("#websiteViewsChart", {
    ...
    initFullCalendar: function() {
        $calendar = $("#fullCalendar"), today = new Date, y = today.getFullYear(), m = today.getMonth(), d = today.getDate(), $calendar.fullCalendar({
            viewRender: function(e, t) { "month" != e.name && $(t).find(".fc-scroller").perfectScrollbar() },
            ...
            select: function(a, i) {
                swal({ title: "Create an Event", html: '<div class="form-group"><input class="form-control" placeholder="Event Title" id="input-field"></div>', showCancelButton: !0, confirmButtonClass: "btn btn-success", cancelButtonClass: "btn btn-danger", buttonsStyling: !1 }).then(function(e) {
                    var t;
                    event_title = $("#input-field").val(), event_title && (t = { title: event_title, start: a, end: i }, $calendar.fullCalendar("renderEvent", t, !0)), $calendar.fullCalendar("unselect")
                }).catch(swal.noop)
            },
            editable: !0,
            eventLimit: !0,
    ...
    initDateTimePicker: function() { $(".datetimepicker").datetimepicker({ icons: { time: "fa fa-clock-o", date: "fa fa-calendar", up: "fa fa-chevron-up", down: "fa fa-chevron-down", previous: "fa fa-chevron-left", next: "fa fa-chevron-right", today: "fa fa-screenshot", clear: "fa fa-trash", close: "fa fa-remove" } }) },
    initPickColor: function() {
        $(".pick-class-label").click(function() {
            var e, t = $(this).attr("new-class"),
    ...
    initMaterialWizard: function() {
        ...
        $(".card-wizard").bootstrapWizard({
            ...
            onTabClick: function(e, t, a) { return !!$(".card-wizard form").valid() },
            onTabShow: function(e, t, a) {
                var i = t.find("li").length,
                    n = a + 1,
                    o = t.closest(".card-wizard");
                i <= n ? ($(o).find(".btn-next").hide(), $(o).find(".btn-finish").show()) : ($(o).find(".btn-next").show(), $(o).find(".btn-finish").hide()), button_text = t.find("li:nth-child(" + n + ") a").html(), setTimeout(function() { $(".moving-tab").text(button_text) }, 150);
                var s = $(".footer-checkbox");
                0 == !a ? $(s).css({ opacity: "0", visibility: "hidden", position: "absolute" }) : $(s).css({ opacity: "1", visibility: "visible" }), r(o, a)
            }
        }), $("#wizard-picture").change(function() {
            ! function(e) {
                {
                    var t;
                    e.files && e.files[0] && ((t = new FileReader).onload = function(e) { $("#wizardPicturePreview").attr("src", e.target.result).fadeIn("slow") }, t.readAsDataURL(e.files[0]))
                }
            }(this)
        }), $('[data-toggle="wizard-radio"]').click(function() { wizard = $(this).closest(".card-wizard"), wizard.find('[data-toggle="wizard-radio"]').removeClass("active"), $(this).addClass("active"), $(wizard).find('[type="radio"]').removeAttr("checked"), $(this).find('[type="radio"]').attr("checked", "true") }), $('[data-toggle="wizard-checkbox"]').click(function() { $(this).hasClass("active") ? ($(this).removeClass("active"), $(this).find('[type="checkbox"]').removeAttr("checked")) : ($(this).addClass("active"), $(this).find('[type="checkbox"]').attr("checked", "true")) }), $(".set-full-height").css("height", "auto"), $(window).resize(function() { $(".card-wizard").each(function() { $wizard = $(this), index = $wizard.bootstrapWizard("currentIndex"), r($wizard, index), $(".moving-tab").css({ transition: "transform 0s" }) }) })
    },
    initCharts: function() {
        var e, t, a, i, n, o;
        ...
        }, optionsRoundedLineChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 10 }), axisX: { showGrid: !1 }, low: 0, high: 50, chartPadding: { top: 0, right: 0, bottom: 0, left: 0 }, showPoint: !1 }, e = new Chartist.Line("#roundedLineChart", dataRoundedLineChart, optionsRoundedLineChart), md.startAnimationForLineChart(e), dataStraightLinesChart = {
            labels: ["'07", "'08", "'09", "'10", "'11", "'12", "'13", "'14", "'15"],
            series: [
                [10, 16, 8, 13, 20, 15, 20, 34, 30]
            ]
        }, optionsStraightLinesChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 0 }), low: 0, high: 50, chartPadding: { top: 0, right: 0, bottom: 0, left: 0 }, classNames: { point: "ct-point ct-white", line: "ct-line ct-white" } }, t = new Chartist.Line("#straightLinesChart", dataStraightLinesChart, optionsStraightLinesChart), md.startAnimationForLineChart(t), dataColouredRoundedLineChart = {
            labels: ["'06", "'07", "'08", "'09", "'10", "'11", "'12", "'13", "'14", "'15"],
            series: [
                [287, 480, 290, 554, 690, 690, 500, 752, 650, 900, 944]
            ]
        }, optionsColouredRoundedLineChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 10 }), axisY: { showGrid: !0, offset: 40 }, axisX: { showGrid: !1 }, low: 0, high: 1e3, showPoint: !0, height: "300px" }, a = new Chartist.Line("#colouredRoundedLineChart", dataColouredRoundedLineChart, optionsColouredRoundedLineChart), md.startAnimationForLineChart(a), dataColouredBarsChart = {
            labels: ["'06", "'07", "'08", "'09", "'10", "'11", "'12", "'13", "'14", "'15"],
            series: [
        ...
        }, optionsColouredBarsChart = { lineSmooth: Chartist.Interpolation.cardinal({ tension: 10 }), axisY: { showGrid: !0, offset: 40 }, axisX: { showGrid: !1 }, low: 0, high: 1e3, showPoint: !0, height: "300px" }, i = new Chartist.Line("#colouredBarsChart", dataColouredBarsChart, optionsColouredBarsChart), md.startAnimationForLineChart(i), Chartist.Pie("#chartPreferences", { labels: ["62%", "32%", "6%"], series: [62, 32, 6] }, { height: "230px" }), n = Chartist.Bar("#simpleBarChart", {
    ...
    initSmallGoogleMaps: function() {
        ...
        t = { zoom: 13, center: e = new google.maps.LatLng(40.748817, -73.985428), scrollwheel: !1, disableDefaultUI: !0, zoomControl: !0, styles: [{ featureType: "water", stylers: [{ saturation: 43 }, { lightness: -11 }, { hue: "#0088ff" }] }, { featureType: "road", elementType: "geometry.fill", stylers: [{ hue: "#ff0000" }, { saturation: -100 }, { lightness: 99 }] }, { featureType: "road", elementType: "geometry.stroke", stylers: [{ color: "#808080" }, { lightness: 54 }] }, { featureType: "landscape.man_made", elementType: "geometry.fill", stylers: [{ color: "#ece2d9" }] }, { featureType: "poi.park", elementType: "geometry.fill", stylers: [{ color: "#ccdca1" }] }, { featureType: "road", elementType: "labels.text.fill", stylers: [{ color: "#767676" }] }, { featureType: "road", elementType: "labels.text.stroke", stylers: [{ color: "#ffffff" }] }, { featureType: "poi", stylers: [{ visibility: "off" }] }, { featureType: "landscape.natural", elementType: "geometry.fill", stylers: [{ visibility: "on" }, { color: "#b8cb93" }] }, { featureType: "poi.park", stylers: [{ visibility: "on" }] }, { featureType: "poi.sports_complex", stylers: [{ visibility: "on" }] }, { featureType: "poi.medical", stylers: [{ visibility: "on" }] }, { featureType: "poi.business", stylers: [{ visibility: "simplified" }] }] }, a = new google.maps.Map(document.getElementById("customSkinMap"), t);
        new google.maps.Marker({ position: e, title: "Custom Skin & Settings Map!" }).setMap(a);
        t = { zoom: 3, scrollwheel: !1, center: e = new google.maps.LatLng(40.748817, -73.985428), mapTypeId: google.maps.MapTypeId.SATELLITE }, a = new google.maps.Map(document.getElementById("satelliteMap"), t);
